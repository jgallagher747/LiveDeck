#!/Users/deepthought-mini/Documents/Python/PyLive/venv/bin/python3.13
...
if __name__ == "__main__":
    ...
    for index, deck in enumerate(streamdecks):
        ...
        # Set a screen image
        image = render_screen_image(deck, os.path.join(ASSETS_PATH, "DepartureMono-Regular.otf"), "DeepThough Mini")
...
# Get connected StreamDecks
deck_manager = DeviceManager.DeviceManager()
streamdecks = deck_manager.enumerate()
